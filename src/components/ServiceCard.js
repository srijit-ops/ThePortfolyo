...
function ServiceCard({enabled, img, name, price, detail}) {
  return (
    <div className={`bg-white dark:bg-[#363636] shadow-[rgba(99,99,99,0.2)_0px_2px_8px_0px] hover:scale-105 transition-all duration-[0.3s] m-8 p-6 rounded-[10px] hover:shadow-[rgba(50,50,93,0.25)_0px_13px_27px_-5px,rgba(0,0,0,0.3)_0px_8px_16px_-8px] cursor-pointer`}>
