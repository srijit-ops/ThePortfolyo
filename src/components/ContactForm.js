    ...
    <div className="w-full">
      ...
      >
        <input
          ...
          name="Name"
          required
          className="block w-full mx-auto my-8 outline-none border border-gray-100 dark:border-[#363636] focus:dark:border-gray-500 focus:border-gray-300 p-3 rounded-[10px] bg-gray-100 dark:bg-[#363636]"
        />
        <input
          type="email"
          placeholder="Email"
